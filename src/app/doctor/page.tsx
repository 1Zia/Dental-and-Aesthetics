    ...
    <main>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {doctor.focusAreas.map((area) => (
              <PremiumCard key={area} className="shadow-none">
                <p className="font-serif text-3xl font-semibold leading-none text-deep-espresso">{area}</p>
              </PremiumCard>
            ))}
          </div>
        </div>
      ...
      <section className="section bg-deep-espresso text-pearl">
        <div className="container-shell max-w-5xl">
          ...
          <blockquote className="balanced mt-6 font-serif text-5xl font-semibold leading-none md:text-7xl">
            &quot;{doctor.quote}&quot;
          </blockquote>
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {associatedTreatments.map((treatment) => (
              ...
              >
                ...
                <h3 className="mt-4 font-serif text-3xl font-semibold leading-none text-deep-espresso">
                  {treatment.title}
                </h3>
